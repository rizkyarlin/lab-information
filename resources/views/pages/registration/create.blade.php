                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('fever') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullPanas" name="fever" {{ old('fever') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('cough') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullBatuk" name="cough" {{ old('cough') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('sore_throat') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullNyeri" name="sore_throat" {{ old('sore_throat') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('shortness_of_breath') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullSesak" name="shortness_of_breath" {{ old('shortness_of_breath') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('flu') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullFlu" name="flu" {{ old('flu') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('fatigue') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullLesu" name="fatigue" {{ old('fatigue') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('headache') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullSakit" name="headache" {{ old('headache') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('diarrhea') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullDiare" name="diarrhea" {{ old('diarrhea') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('nausea_or_vomiting') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullMual" name="nausea_or_vomiting" {{ old('nausea_or_vomiting') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('comorbid') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullKomorbid" name="comorbid" {{ old('comorbid') == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('using_ventilator') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullVentilator" name="using_ventilator" {{ old('using_ventilator') == "0" ? 'checked' : '' }} value="0">
