                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('fever') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakPanas" name="fever" value="2" {{ old('fever', $registration->symptom->fever) == "2" ? 'checked' : '' }}>
                                        <label for="tidakPanas">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullPanas" name="fever" {{ old('fever', $registration->symptom->fever) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('cough') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakBatuk" name="cough" value="2" {{ old('cough', $registration->symptom->cough) == "2" ? 'checked' : '' }}>
                                        <label for="tidakBatuk">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullBatuk" name="cough" {{ old('cough', $registration->symptom->cough) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('sore_throat') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakNyeri" name="sore_throat" value="2" {{ old('sore_throat', $registration->symptom->sore_throat) == "2" ? 'checked' : '' }}>
                                        <label for="tidakNyeri">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullNyeri" name="sore_throat" {{ old('sore_throat', $registration->symptom->sore_throat) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('shortness_of_breath') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakSesak" name="shortness_of_breath" value="2" {{ old('shortness_of_breath', $registration->symptom->shortness_of_breath) == "2" ? 'checked' : '' }}>
                                        <label for="tidakSesak">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullSesak" name="shortness_of_breath" {{ old('shortness_of_breath', $registration->symptom->shortness_of_breath) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('flu') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakFlu" name="flu" value="2" {{ old('flu', $registration->symptom->flu) == "2" ? 'checked' : '' }}>
                                        <label for="tidakFlu">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullFlu" name="flu" {{ old('flu', $registration->symptom->flu) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('fatigue') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakLesu" name="fatigue" value="2" {{ old('fatigue', $registration->symptom->fatigue) == "2" ? 'checked' : '' }}>
                                        <label for="tidakLesu">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullLesu" name="fatigue" {{ old('fatigue', $registration->symptom->fatigue) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('headache') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakSakit" name="headache" value="2" {{ old('headache', $registration->symptom->headache) == "2" ? 'checked' : '' }}>
                                        <label for="tidakSakit">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullSakit" name="headache" {{ old('headache', $registration->symptom->headache) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('diarrhea') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakDiare" name="diarrhea" value="2" {{ old('diarrhea', $registration->symptom->diarrhea) == "2" ? 'checked' : '' }}>
                                        <label for="tidakDiare">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullDiare" name="diarrhea" {{ old('diarrhea', $registration->symptom->diarrhea) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('nausea_or_vomiting') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakMual" name="nausea_or_vomiting" value="2" {{ old('nausea_or_vomiting', $registration->symptom->nausea_or_vomiting) == "2" ? 'checked' : '' }}>
                                        <label for="tidakMual">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullMual" name="nausea_or_vomiting" {{ old('nausea_or_vomiting', $registration->symptom->nausea_or_vomiting) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('comorbid') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakKomorbid" name="comorbid" value="2" {{ old('comorbid', $registration->symptom->comorbid) == "2" ? 'checked' : '' }}>
                                        <label for="tidakKomorbid">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullKomorbid" name="comorbid" {{ old('comorbid', $registration->symptom->comorbid) == "0" ? 'checked' : '' }} value="0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 mt-2">
                                <div class="@error('using_ventilator') form-control is-invalid @enderror">
                                    ...
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="tidakVentilator" name="using_ventilator" value="2" {{ old('using_ventilator', $registration->symptom->using_ventilator) == "2" ? 'checked' : '' }}>
                                        <label for="tidakVentilator">Tidak</label>
                                    </div>
                                    <div class="icheck-primary d-inline ml-1">
                                        <input type="radio" id="nullVentilator" name="using_ventilator" {{ old('using_ventilator', $registration->symptom->using_ventilator) == "0" ? 'checked' : '' }} value="0">
