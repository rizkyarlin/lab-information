...
class UpdateNullableFieldOnRegistrations extends Migration
{
    ...
    public function up()
    {
        ...
        CHANGE COLUMN `registration_date` `registration_date` VARCHAR(191) CHARACTER SET "utf8" NULL,
    ...
    public function down()
    {
        ...
        CHANGE COLUMN `registration_date` `registration_date` VARCHAR(191) CHARACTER SET "utf8" NOT NULL,
